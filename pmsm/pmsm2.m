...
function simulate_pmsm()
  ...
  save -ascii "pmsm_data.dat" ids iqs ts;
  system("gnuplot -e 'set terminal dumb; plot \"pmsm_data.dat\" using 3:1 with lines title \"Id\", \"pmsm_data.dat\" using 3:2 with lines title \"Iq\"'");
endfunction
