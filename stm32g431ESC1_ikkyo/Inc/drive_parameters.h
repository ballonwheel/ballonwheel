...
#define PLL_KP_GAIN                         160
#define PLL_KI_GAIN                         6
...
#define PID_TORQUE_KI_DEFAULT               3699
#define PID_TORQUE_KD_DEFAULT               100
#define PID_FLUX_KP_DEFAULT                 2312
#define PID_FLUX_KI_DEFAULT                 3699
...
#define PID_SPEED_KP_DEFAULT                2096/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
#define PID_SPEED_KI_DEFAULT                235/(SPEED_UNIT/10) /* Workbench compute the gain for 01Hz unit*/
